                        ...
                        return (
                            <div key={committee.key} className="bg-[#f5f5f5] rounded-lg shadow-xl overflow-hidden mb-12">
                                ...
                                <div className="mt-6 px-6 flex flex-col items-center pb-12">
                                    ...
                                    >
                                        <div
                                            className={`bg-white p-6 shadow-lg text-gray-700 text-lg leading-relaxed ${expandedCommittee === committee.key ? '' : 'truncate-lines'
                                                }`}
                                        >
                                            <div
                                                className={`${expandedCommittee === committee.key ? 'line-clamp-none' : 'line-clamp-3'
                                                    }`}
                                            >
                                                {committee.termsOfReferenceGlimpse}
                                            </div>
                                        </div>
                                        <div className="w-[130px] mt-8 mx-auto">
                                            <Link
                                                className="font-sans flex justify-center gap-2 items-center mx-auto shadow-xl text-[14px] text-[#004B8B] border-[1px] border-[#004B8B] transition-all duration-700 backdrop-blur-md lg:font-semibold isolation-auto before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-[#004B8B] hover:text-gray-50 before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px- py-1 overflow-hidden border-2 rounded-full group"
                                            ...
                                            >
                                                ...
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 16 19"
                                                    className="w-7 h-7 justify-end bg-gray-50 group-hover:rotate-90 group-hover:bg-gray-50 text-gray-50 ease-linear duration-300 rounded-full border border-gray-700 group-hover:border-none p-2 rotate-45"
                                                >
                                                    <path
